-- Fix RPC ambiguity after migrating material requirements to production_order_materials
-- This migration removes overloaded calculate_material_requirements variants
-- and recreates a single bigint signature that matches the current API usage.
...
as $$
begin
  delete from shveyka.production_order_materials
